...
namespace SerapKeremGameKit._Managers
{
    ...
    public class StateManager : MonoSingleton<StateManager>
    {
        ...
        public void SetOnWin()
        {
            ...
            // Show interstitial ad on level win (every 2 levels)
            if (AdManager.Instance != null)
                AdManager.Instance.ShowInterstitialOnLevelComplete();
        }
        ...
        public void SetOnLose()
        {
            ...
            // Show interstitial ad on level lose
            if (AdManager.Instance != null)
                AdManager.Instance.ShowInterstitialOnRetry();
        }
