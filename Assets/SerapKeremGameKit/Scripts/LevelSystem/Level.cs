...
namespace SerapKeremGameKit._LevelSystem
{
    public class Level : MonoBehaviour
    {
        ...
        /// <summary>Whether this level was procedurally generated (not from a prefab).</summary>
        [HideInInspector] public bool IsProceduralLevel = false;
        ...
        /// <summary>
        /// Set the lines parent transform for procedural levels.
        /// </summary>
        public void SetLinesParent(Transform parent)
        {
            _linesParent = parent;
        }
    }
