...
namespace SerapKeremGameKit._Audio
{
    public sealed class AudioManager : MonoSingleton<AudioManager>
    {
        ...
        /// <summary>
        /// Register a new AudioData entry at runtime.
        /// Used by SoundLibrary to inject procedurally-generated sounds.
        /// </summary>
        public void RegisterAudioData(AudioData data)
        {
            ...
            // Also add to the serialized list for consistency
            if (!_audioList.Contains(data))
            {
                _audioList.Add(data);
            }
        }
