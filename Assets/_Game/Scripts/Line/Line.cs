...
namespace _Game.Line
{
    ...
    public class Line : MonoBehaviour
    {
        ...
        [SerializeField] private string _collisionSoundKey = "line_collide";
        [SerializeField] private string _completeSoundKey = "line_complete";
        ...
        private void HandleAnimationCompleted()
        {
            ...
            // Play completion sound for successfully cleared lines
            if (AudioManager.IsInitialized && !string.IsNullOrEmpty(_completeSoundKey))
                AudioManager.Instance.Play(_completeSoundKey);
