...
namespace _Game.Line
{
    public class LineMaterialHandler : MonoBehaviour
    {
        ...
        [SerializeField] private Color _failureColor = new Color(1f, 0.420f, 0.208f, 1f); // ThemeConfig.FailureColor
        [SerializeField] private Color _successColor = new Color(0.224f, 1f, 0.078f, 1f); // ThemeConfig.SuccessColor
